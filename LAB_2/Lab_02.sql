-- Perform SQL Commands for Creating Tables and Inserting Data (CREATE, INSERT) 
...
VALUES
    (101, 'MEET', 'MAVDI', 10000.00, '2025-03-01'),
    (102, 'JAY', 'MADHAPAR', 5000.00, '2026-01-04'),
    (103, 'RAHUL', 'BEDI', 3500.00, '2026-01-07'),
    (104, 'RIYA', 'MAVDI', 1200.00, '2025-06-07'),
    (105, 'MANSI', 'KKV HALL', 3000.00, '2024-03-02'),
    (106, 'DIYA', 'MADHAPAR', 2000.00, '2025-03-01'),
    (107, 'MIRAL', 'BEDI', 1000.00, '2025-09-05'),
    (108, 'UDAY', 'UMIYA CHOWK', 5000.00, '2025-07-02'),
    (
        109,
        'CHARMI',
        'SHITAL PARK',
    ...
    (110, 'BHAVIN', 'RING ROAD', 8000.00, '2025-02-02'),
    (111, 'BANSI', NULL, 9000.00, '2025-01-01');
